        ...
        pageSetting: {
          ...
          table: {
            columns: [
              ...
              utils.enumColumn("proxyProtocol", null, "Protocol"),
              utils.enumColumn("proxyType", null, "Type"),
              utils.positiveProgress("usage", "maxUseCount", "currentUseCount"),
              utils.column("maxUseCount", "MaxCon"),
              utils.column("currentUseCount", "CurCon"),
              utils.negativeProgress("blockRate", "blockMaxCount", "blockCurrentCount"),
              utils.column("blockMaxCount", "BMaxCnt"),
              utils.column("blockCurrentCount", "BCurCnt"),
              utils.column("blockTimeout", "BTimeout(min)"),
              utils.dateColumn("blockTimeoutTime"),
